...
* OpenAI - `OPENAI_API_KEY` and OAuth via `maki auth login openai` or `/login` in the TUI.
* All providers - use `maki auth login` or `/login` for interactive authentication.
